        ...
        <div className=" text-[11px] ">
            ...
            <div className="mb-2">
                {!marketData || Object.keys(marketData).length === 0 ? (
                    ...
                    marketData.shorts?.slice(0, 7).map((short) => {
                        const solidPercentage = Math.min(
                            (short.size / 3) * 30,
                            30
                        ) // Dynamically calculate solid color percentage
                        ...
                        return (
                            ...
                            rgba(255, 107, 107, 0.8) ${solidPercentage}%, 
                            rgba(255, 107, 107, 0.3) ${solidPercentage}%, 
            ...
            {!marketData || Object.keys(marketData).length === 0 ? (
                ...
                marketData.longs?.slice(0, 7).map((long) => {
                    const solidPercentage = Math.min((long.size / 3) * 30, 30) // Dynamically calculate solid color percentage
                    ...
                    return (
                        ...
                        rgba(50, 205, 137, 0.8) ${solidPercentage}%, 
                        rgba(50, 205, 137, 0.3) ${solidPercentage}%, 
