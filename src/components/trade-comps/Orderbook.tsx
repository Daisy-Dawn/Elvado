...
const Orderbook = () => {
    ...
    return (
        <div className="min-h-[50vh]">
            <div className="border-b-[1px] text-[12px] py-[0.85rem] px-[0.5rem]  border-b-[#374151] flex justify-between items-center ">
                <p className="font-medium text-[13px]">Order Book</p>
