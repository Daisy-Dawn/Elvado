...
const Orderbook = () => {
    ...
    return (
        <div className="min-h-[50vh]">
            <div className="border-b-[1px] text-[12px] py-[0.85rem] px-[1rem] xl:px-[2rem] border-b-[#374151] flex justify-between items-center ">
                <p className="font-medium text-[13px] xl:text-[15px]">
                    Order Book
                </p>
